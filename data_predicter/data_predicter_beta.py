...
if 'target' in st.session_state and st.session_state.target is not None:
    if st.button("Train Model 🚚"):
        ...
        with st.spinner("Please wait while the model is being trained. If you use streamlit cloud version app, that can take a long time due to cloud environment"):
